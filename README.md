...
> **Alpha software.** This is Fieldnotes v0.1.2, an early release for invited testers. Expect rough edges. It is distributed as an unsigned build (see [Installing](#installing) for the macOS workaround).
